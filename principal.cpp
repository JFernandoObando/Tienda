...
{
    ui->setupUi(this);
   ui->outDetalle->setStyleSheet("QHeaderView::section { background-color:rgb(44, 44, 44)}");
    ...
    connect(ui->mnuFinalizar,SIGNAL(triggered(bool)),this,SLOT(finalizarDatos()));
...
void Principal::inicializarWidgets()
{
    ...
    ui->outDetalle->horizontalHeader()->setStyleSheet("color: white");
