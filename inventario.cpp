...
{
    ui->setupUi(this);
    ui->outProductos->setStyleSheet("QHeaderView::section { background-color:rgb(44, 44, 44)}");
    ...
    QStringList cabecera = {"Código", "Producto", "Precio"};
...
void Inventario::setProductos(int codigo, QString producto, float precio)
{
    ...
    ui->outProductos->horizontalHeader()->setStyleSheet("color: white");
